...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/">
    <nstrgmpr:vendor>
      ...
      <nstrgmpr:vendorName>
        <xsl:value-of select="nsmpr0:VENDOR_NAME"/>
      </nstrgmpr:vendorName>
      <nstrgmpr:vendorNameAlt>
        <xsl:value-of select="nsmpr0:VENDOR_NAME_ALT"/>
      </nstrgmpr:vendorNameAlt>
      <nstrgmpr:segment1>
      ...
      <nstrgmpr:employeeId>
        <xsl:value-of select="nsmpr0:EMPLOYEE_ID"/>
      </nstrgmpr:employeeId>
      <nstrgmpr:vendorTypeLookupCode>
        <xsl:value-of select="nsmpr0:VENDOR_TYPE_LOOKUP_CODE"/>
      </nstrgmpr:vendorTypeLookupCode>
      <nstrgmpr:customerNum>
        <xsl:value-of select="nsmpr0:CUSTOMER_NUM"/>
      </nstrgmpr:customerNum>
      <nstrgmpr:oneTimeFlag>
        <xsl:value-of select="nsmpr0:ONE_TIME_FLAG"/>
      </nstrgmpr:oneTimeFlag>
      <nstrgmpr:parentVendorId>
        <xsl:value-of select="nsmpr0:PARENT_VENDOR_ID"/>
      </nstrgmpr:parentVendorId>
      <nstrgmpr:minOrderAmount>
        <xsl:value-of select="nsmpr0:MIN_ORDER_AMOUNT"/>
      </nstrgmpr:minOrderAmount>
      ...
      <nstrgmpr:creditStatusLookupCode>
        <xsl:value-of select="nsmpr0:CREDIT_STATUS_LOOKUP_CODE"/>
      </nstrgmpr:creditStatusLookupCode>
      <nstrgmpr:creditLimit>
        <xsl:value-of select="nsmpr0:CREDIT_LIMIT"/>
      </nstrgmpr:creditLimit>
      ...
      <nstrgmpr:exchangeDateLookupCode>
        <xsl:value-of select="nsmpr0:EXCHANGE_DATE_LOOKUP_CODE"/>
      </nstrgmpr:exchangeDateLookupCode>
      ...
      <nstrgmpr:discLostCodeCombinationId>
        <xsl:value-of select="nsmpr0:DISC_LOST_CODE_COMBINATION_ID"/>
      </nstrgmpr:discLostCodeCombinationId>
      <nstrgmpr:discTakenCodeCombinationId>
        <xsl:value-of select="nsmpr0:DISC_TAKEN_CODE_COMBINATION_ID"/>
      </nstrgmpr:discTakenCodeCombinationId>
      <nstrgmpr:expenseCodeCombinationId>
        <xsl:value-of select="nsmpr0:EXPENSE_CODE_COMBINATION_ID"/>
      </nstrgmpr:expenseCodeCombinationId>
      <nstrgmpr:prepayCodeCombinationId>
        <xsl:value-of select="nsmpr0:PREPAY_CODE_COMBINATION_ID"/>
      </nstrgmpr:prepayCodeCombinationId>
      <nstrgmpr:num1099>
        <xsl:value-of select="nsmpr0:NUM_1099"/>
      </nstrgmpr:num1099>
      <nstrgmpr:type1099>
        <xsl:value-of select="nsmpr0:TYPE_1099"/>
      </nstrgmpr:type1099>
      <nstrgmpr:withholdingStatusLookupCode>
        <xsl:value-of select="nsmpr0:WITHHOLDING_STATUS_LOOKUP_CODE"/>
      </nstrgmpr:withholdingStatusLookupCode>
      <nstrgmpr:withholdingStartDate>
        <xsl:value-of select="nsmpr0:WITHHOLDING_START_DATE"/>
      </nstrgmpr:withholdingStartDate>
      <nstrgmpr:organizationTypeLookupCode>
        <xsl:value-of select="nsmpr0:ORGANIZATION_TYPE_LOOKUP_CODE"/>
      </nstrgmpr:organizationTypeLookupCode>
      <nstrgmpr:vatCode>
      ...
      <nstrgmpr:minorityGroupLookupCode>
        <xsl:value-of select="nsmpr0:MINORITY_GROUP_LOOKUP_CODE"/>
      </nstrgmpr:minorityGroupLookupCode>
      ...
      <nstrgmpr:womenOwnedFlag>
        <xsl:value-of select="nsmpr0:WOMEN_OWNED_FLAG"/>
      </nstrgmpr:womenOwnedFlag>
      <nstrgmpr:smallBusinessFlag>
        <xsl:value-of select="nsmpr0:SMALL_BUSINESS_FLAG"/>
      </nstrgmpr:smallBusinessFlag>
      <nstrgmpr:standardIndustryClass>
        <xsl:value-of select="nsmpr0:STANDARD_INDUSTRY_CLASS"/>
      </nstrgmpr:standardIndustryClass>
      <nstrgmpr:holdFlag>
        <xsl:value-of select="nsmpr0:HOLD_FLAG"/>
      </nstrgmpr:holdFlag>
      <nstrgmpr:purchasingHoldReason>
        <xsl:value-of select="nsmpr0:PURCHASING_HOLD_REASON"/>
      </nstrgmpr:purchasingHoldReason>
      <nstrgmpr:holdBy>
        <xsl:value-of select="nsmpr0:HOLD_BY"/>
      </nstrgmpr:holdBy>
      <nstrgmpr:holdDate>
        <xsl:value-of select="nsmpr0:HOLD_DATE"/>
      </nstrgmpr:holdDate>
      <nstrgmpr:termsDateBasis>
        <xsl:value-of select="nsmpr0:TERMS_DATE_BASIS"/>
      </nstrgmpr:termsDateBasis>
      <nstrgmpr:priceTolerance>
        <xsl:value-of select="nsmpr0:PRICE_TOLERANCE"/>
      </nstrgmpr:priceTolerance>
      ...
      <nstrgmpr:allowUnorderedReceiptsFlag>
        <xsl:value-of select="nsmpr0:ALLOW_UNORDERED_RECEIPTS_FLAG"/>
      </nstrgmpr:allowUnorderedReceiptsFlag>
      ...
      <nstrgmpr:taxVerificationDate>
        <xsl:value-of select="nsmpr0:TAX_VERIFICATION_DATE"/>
      </nstrgmpr:taxVerificationDate>
      <nstrgmpr:nameControl>
        <xsl:value-of select="nsmpr0:NAME_CONTROL"/>
      </nstrgmpr:nameControl>
      <nstrgmpr:stateReportableFlag>
        <xsl:value-of select="nsmpr0:STATE_REPORTABLE_FLAG"/>
      </nstrgmpr:stateReportableFlag>
      <nstrgmpr:federalReportableFlag>
        <xsl:value-of select="nsmpr0:FEDERAL_REPORTABLE_FLAG"/>
      </nstrgmpr:federalReportableFlag>
      ...
      <nstrgmpr:autoCalculateInterestFlag>
        <xsl:value-of select="nsmpr0:AUTO_CALCULATE_INTEREST_FLAG"/>
      </nstrgmpr:autoCalculateInterestFlag>
      ...
      <nstrgmpr:taxReportingName>
        <xsl:value-of select="nsmpr0:TAX_REPORTING_NAME"/>
      </nstrgmpr:taxReportingName>
      ...
      <nstrgmpr:partyId>
        <xsl:value-of select="nsmpr0:PARTY_ID"/>
      </nstrgmpr:partyId>
      <nstrgmpr:parentPartyId>
        <xsl:value-of select="nsmpr0:PARENT_PARTY_ID"/>
      </nstrgmpr:parentPartyId>
      <nstrgmpr:niNumber>
        <xsl:value-of select="nsmpr0:NI_NUMBER"/>
      </nstrgmpr:niNumber>
      <nstrgmpr:tcaSyncNum1099>
        <xsl:value-of select="nsmpr0:TCA_SYNC_NUM_1099"/>
      </nstrgmpr:tcaSyncNum1099>
      <nstrgmpr:tcaSyncVendorName>
        <xsl:value-of select="nsmpr0:TCA_SYNC_VENDOR_NAME"/>
      </nstrgmpr:tcaSyncVendorName>
      <nstrgmpr:tcaSyncVatRegNum>
        <xsl:value-of select="nsmpr0:TCA_SYNC_VAT_REG_NUM"/>
      </nstrgmpr:tcaSyncVatRegNum>
      <nstrgmpr:uniqueTaxReferenceNum>
        <xsl:value-of select="nsmpr0:UNIQUE_TAX_REFERENCE_NUM"/>
      </nstrgmpr:uniqueTaxReferenceNum>
      <nstrgmpr:partnershipUtr>
        <xsl:value-of select="nsmpr0:PARTNERSHIP_UTR"/>
      </nstrgmpr:partnershipUtr>
      <nstrgmpr:partnershipName>
        <xsl:value-of select="nsmpr0:PARTNERSHIP_NAME"/>
      </nstrgmpr:partnershipName>
      <nstrgmpr:cisEnabledFlag>
        <xsl:value-of select="nsmpr0:CIS_ENABLED_FLAG"/>
      </nstrgmpr:cisEnabledFlag>
      <nstrgmpr:firstName>
        <xsl:value-of select="nsmpr0:FIRST_NAME"/>
      </nstrgmpr:firstName>
      <nstrgmpr:secondName>
        <xsl:value-of select="nsmpr0:SECOND_NAME"/>
      </nstrgmpr:secondName>
      <nstrgmpr:lastName>
        <xsl:value-of select="nsmpr0:LAST_NAME"/>
      </nstrgmpr:lastName>
      <nstrgmpr:salutation>
        <xsl:value-of select="nsmpr0:SALUTATION"/>
      </nstrgmpr:salutation>
      <nstrgmpr:tradingName>
        <xsl:value-of select="nsmpr0:TRADING_NAME"/>
      </nstrgmpr:tradingName>
      <nstrgmpr:workReference>
        <xsl:value-of select="nsmpr0:WORK_REFERENCE"/>
      </nstrgmpr:workReference>
      <nstrgmpr:companyRegistrationNumber>
        <xsl:value-of select="nsmpr0:COMPANY_REGISTRATION_NUMBER"/>
      </nstrgmpr:companyRegistrationNumber>
      <nstrgmpr:nationalInsuranceNumber>
        <xsl:value-of select="nsmpr0:NATIONAL_INSURANCE_NUMBER"/>
      </nstrgmpr:nationalInsuranceNumber>
      <nstrgmpr:verificationNumber>
        <xsl:value-of select="nsmpr0:VERIFICATION_NUMBER"/>
      </nstrgmpr:verificationNumber>
      <nstrgmpr:verificationRequestId>
        <xsl:value-of select="nsmpr0:VERIFICATION_REQUEST_ID"/>
      </nstrgmpr:verificationRequestId>
      <nstrgmpr:matchStatusFlag>
        <xsl:value-of select="nsmpr0:MATCH_STATUS_FLAG"/>
      </nstrgmpr:matchStatusFlag>
      <nstrgmpr:cisVerificationDate>
        <xsl:value-of select="nsmpr0:CIS_VERIFICATION_DATE"/>
      </nstrgmpr:cisVerificationDate>
      <nstrgmpr:individual1099>
        <xsl:value-of select="nsmpr0:INDIVIDUAL_1099"/>
      </nstrgmpr:individual1099>
      <nstrgmpr:payAwtGroupId>
        <xsl:value-of select="nsmpr0:PAY_AWT_GROUP_ID"/>
      </nstrgmpr:payAwtGroupId>
      <nstrgmpr:cisParentVendorId>
        <xsl:value-of select="nsmpr0:CIS_PARENT_VENDOR_ID"/>
      </nstrgmpr:cisParentVendorId>
      <nstrgmpr:busClassLastCertifiedDate>
        <xsl:value-of select="nsmpr0:BUS_CLASS_LAST_CERTIFIED_DATE"/>
      </nstrgmpr:busClassLastCertifiedDate>
      <nstrgmpr:busClassLastCertifiedBy>
        <xsl:value-of select="nsmpr0:BUS_CLASS_LAST_CERTIFIED_BY"/>
      </nstrgmpr:busClassLastCertifiedBy>
    </nstrgmpr:vendor>
  </xsl:template>
